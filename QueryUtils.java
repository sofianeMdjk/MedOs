...
public class QueryUtils {
    public static final String  URL_LOGIN = MainApp.ip_adress+"/medos/php/patient/loginp.php";
    public static final String URL_VERIFY_EXISTS = MainApp.ip_adress+"/medos/php/patient/exist.php";
    public static final String URL_TQueue = MainApp.ip_adress+"/medos/php/queue/tqueue.php";
